...
public class MinimizeWeightedDelayAMPL {
    ...
    public static void main(String[] args) {
        try {
            ...
            ampl.read("src/main/ampl/weighted_delay.mod"); // Caminho relativo para o arquivo weighted_delay.mod

            // Defina os dados do problema
            ...
            double[] peso = {1,10, 9,10,10, 4, 3, 2,10, 3, 7, 3, 1, 3,10, 4, 7, 7, 4, 7, 5, 3, 5, 4, 9, 5, 2, 8,10, 4, 7, 4, 9, 5, 7, 7, 5,10, 1, 3}; // Pesos associados a cada trabalho
            ...
            double zIP = ampl.getObjective("AtrasoTotalPonderado").value();

            // Imprima os resultados
            System.out.println("Optimal weighted delay: " + zIP);
